...
|Projeto | Situação |
|--------|----------|
| [Projeto 01 - Mini Sistema de Tarefas](https://github.com/sudosamm/projetos-3ds/blob/main/projetos/projeto-01.md) | <!--P1_START--> Apenas 1 horas restantes para a entrega final! <!--P1_END--> |
| [Projeto 02 - Sistema de Loja Mobile](https://github.com/sudosamm/projetos-3ds/blob/main/projetos/projeto-02.md) | <!--P2_START--> 12 dias e 1 horas restantes para a entrega final! <!--P2_END--> |
## Pontuação
